...
<div class="container">
      ...
      <div class="card-body">
          <div class="col-md-6 offset-md-3">
              <form id="validateForm" @submit.prevent="updatePaiement" enctype="multipart/form-data" novalidate> 
...
export default {
    ...
    methods : 
    {
        loadData()
        {
            let url = this.url+`/api/paiement/get_paiement/${this.$route.params.id}`;
        ...
        updatePaiement()
        {
            ...
            if (!this.errors.length)
            {
                ...
                let url = this.url + `/api/paiement/update_paiement/${this.$route.params.id}`;
